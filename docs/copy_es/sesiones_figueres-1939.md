...
1 de febrero de 1939 · Sesión núm. {{sesion.1939-02-01-69.num|id}} · Guerra · Extracto oficial, páginas sin verificar (metadatos del proyecto)
...
El debate preparado «Las Cortes en guerra» reúne {{bib.guerra.entradas}} intervenciones de {{bib.guerra.sesiones|letra}} sesiones, de octubre de 1936 a esta.
...
> sesiones. Congreso de los Diputados, núm. {{sesion.1939-02-01-69.diario_num}}»; fecha = «1 de febrero de 1939»;
