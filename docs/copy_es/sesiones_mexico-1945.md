...
17 de agosto y 7 a 9 de noviembre de 1945 · Sesiones núm. {{sesion.1945-08-17-71.num|id}} a {{sesion.1945-11-09-74.num|id}} · México · Extracto oficial de las sesiones celebradas en México, páginas sin verificar (metadatos del proyecto)
...
En 1945 las Cortes se reúnen en la Ciudad de México. Esta puerta abre {{puerta.mexico-1945.sesiones|letra}} de sus {{fuente.serie.extracto_mexico|letra}} sesiones.
...
El debate preparado «Las Cortes en el exilio» reúne {{bib.exilio.entradas}} intervenciones de las {{bib.exilio.sesiones|letra}} sesiones de México.

> [nota de diseño] `CopiarConsulta` con el filtro Desde 01/01/1945 y el recuento `{{busqueda.ses.presidente_interino.n}}`.
...
> celebradas en México, núm. {{sesion.1945-08-17-71.diario_num}}»; fecha = «17 de agosto de 1945»; edicion =
