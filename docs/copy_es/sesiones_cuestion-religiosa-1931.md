...
13 de octubre de 1931 · Sesión núm. {{sesion.1931-10-13-55.num|id}} · Constituyentes · DSCCRE núm. {{sesion.1931-10-13-55.diario_num|id}}, pp. {{sesion.1931-10-13-55.paginas}} (metadatos del proyecto)
...
Una sola barra: el artículo 24, aprobado por {{voto.178-59.si}} votos contra {{voto.178-59.no}}.
...
El debate preparado «Cuestión religiosa (art. 26)» reúne {{bib.religiosa.entradas}} intervenciones de {{bib.religiosa.sesiones|letra}} sesiones. Su nombre usa otro número de artículo que el Diario de aquel día, que habla del artículo 24.

> [nota de diseño] `CopiarConsulta` sin filtros, recuento `{{busqueda.catolica.n}}` (marcador compartido con la página
