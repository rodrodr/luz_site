...
4 de julio de 1934 · Sesión núm. {{sesion.1934-07-04-112.num|id}} · 1933-1935 · DSC núm. {{sesion.1934-07-04-112.diario_num|id}}, pp. {{sesion.1934-07-04-112.paginas}} (metadatos del proyecto)
...
Es la última sesión antes del verano: la siguiente es la del {{puerta.pistola-1934.siguiente|fecha_larga}}.
...
> `{{busqueda.ses.pistola.dia}}`. La de Muñoz Martínez es la acotación «Su señoría fue el primero que en cierta
