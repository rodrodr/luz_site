...
Azaña y el Estatuto de Cataluña · 27 de mayo de 1932

<!-- sesiones.estatuto-1932.meta.descripcion -->
Azaña defiende el Estatuto de Cataluña en las Constituyentes, en la intervención de habla más larga del corpus.

<!-- sesiones.estatuto-1932.antetitulo -->
27 de mayo de 1932 · Sesión núm. {{sesion.1932-05-27-173.num|id}} · Constituyentes · DSCCRE núm. {{sesion.1932-05-27-173.diario_num|id}}, pp. {{sesion.1932-05-27-173.paginas}} (metadatos del proyecto)
...
Manuel Azaña, Presidente del Consejo de Ministros, defiende en la Cámara el proyecto de Estatuto de Cataluña, en un discurso de más de {{puerta.estatuto-1932.umbral}} palabras.

<!-- sesiones.estatuto-1932.que_paso.2 -->
Es la intervención de habla más larga del corpus.
...
Filtros › Fecha y sesión: Desde y Hasta 27/05/1932. Salen {{sesion.1932-05-27-173.filas_v3}} intervenciones en el explorador; con «Solo lo que se habla», {{sesion.1932-05-27-173.habla_v3}}.

<!-- sesiones.estatuto-1932.explorador.consulta -->
"vivir de otra manera"

<!-- sesiones.estatuto-1932.explorador.recuento -->
Recuento del {{busquedas.fecha|fecha_larga}}: {{busqueda.ses.otra_manera.n}} intervenciones en el explorador.
...
El debate preparado «Estatuto de Cataluña» reúne {{bib.estatuto.entradas}} intervenciones de {{bib.estatuto.sesiones|letra}} sesiones, de mayo a septiembre de 1932.

> [nota de diseño] `CopiarConsulta` sin filtros; recuento `{{busqueda.ses.otra_manera.n}}` («dos intervenciones»: la
> frase de la nota solo vale mientras el recuento sea 2, y el exportador lo comprueba).

## Lo que no está

<!-- sesiones.estatuto-1932.no_esta.texto -->
La votación del Estatuto no es de este día: llega el 9 de septiembre de 1932, por {{voto.314-24.si}} votos contra {{voto.314-24.no}}.
...
Diario de Sesiones de las Cortes Constituyentes de la República Española, núm. {{sesion.1932-05-27-173.diario_num|id}}, 27 de mayo de 1932, pp. {{sesion.1932-05-27-173.paginas}} (metadatos del proyecto). Luz y Taquígrafos, fila {{cita.estatuto.azana.v3|id}}.
