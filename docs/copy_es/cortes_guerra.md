...
1-X-1936 → 1-II-1939 · {{etapa.IV.sesiones}} sesiones · {{etapa.IV.serie}}
...
De los {{etapa.IV.meses}} meses de la etapa, {{etapa.IV.meses_con_sesion}} tienen alguna sesión. Los demás llevan contorno; su causa no sale del corpus.

<!-- cortes.guerra.calendario.presidente -->
Bajo el calendario van dos bandas de los metadatos del proyecto. Diego Martínez Barrio es el presidente titular de las {{etapa.IV.pres.martinez_barrio|letra}}.
