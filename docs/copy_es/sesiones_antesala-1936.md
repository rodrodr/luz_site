...
16 de junio y 1 de julio de 1936 · Sesiones núm. {{sesion.1936-06-16-45.num|id}} y {{sesion.1936-07-01-54.num|id}} · Cortes de 1936 · DSC núm. {{sesion.1936-06-16-45.diario_num|id}}, pp. {{sesion.1936-06-16-45.paginas}}, y núm. {{sesion.1936-07-01-54.diario_num|id}}, pp. {{sesion.1936-07-01-54.paginas}} (metadatos del proyecto)
...
El debate preparado «Orden público en la primavera de 1936» reúne {{bib.orden_publico.entradas}} intervenciones de {{bib.orden_publico.sesiones|letra}} sesiones, de abril a julio de 1936.

> [nota de diseño] `CopiarConsulta` sin filtros, recuento `{{busqueda.ses.suprimidas.n}}`. Las otras dos acotaciones
