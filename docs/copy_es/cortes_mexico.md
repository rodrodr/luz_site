...
10-I → 9-XI-1945 · {{etapa.V.sesiones}} sesiones · {{etapa.V.serie}}
...
> {{sesion.1945-08-17-71.filas.v3|letra}} filas en la v3.
...
Tras el salto de 1939 a 1945, {{etapa.V.meses_con_sesion|letra}} meses de 1945 tienen sesión: enero, agosto y noviembre.
