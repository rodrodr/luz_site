...
2 de febrero de 1933 · Sesión núm. {{sesion.1933-02-02-288.num|id}} · Constituyentes · DSCCRE núm. {{sesion.1933-02-02-288.diario_num|id}}, pp. {{sesion.1933-02-02-288.paginas}} (metadatos del proyecto)
...
Con «Solo lo que se habla», que deja fuera sumarios y comentarios, son {{busqueda.casas_viejas.m1933_02_habla}} y {{busqueda.ses.casas_viejas.m1933_03_habla}}.

<!-- sesiones.casas-viejas-1933.explorador.consulta.frase -->
La frase de Azaña, entre comillas, sale en {{busqueda.ses.tenia_que_ocurrir.n|letra}} intervenciones: la suya y la de Martínez Barrio.
...
> [nota de diseño] `CopiarConsulta` sin filtros, recuento `{{busqueda.casas_viejas.n}}` (todo el corpus, todas las
