# Copy EN · Gateway `cuestion-religiosa-1931` · 13 October 1931 · «España ha dejado de ser católica»

> [nota de diseño] Traducción de `docs/copy_es/sesiones_cuestion-religiosa-1931.md` según el glosario. El H1 y el
> `<title>` conservan la cita en español; la traducción va en la entradilla. Las citas (claves `.cita.`) quedan en
> español; su traducción, en `_trad_pendientes.txt`.

<!-- sesiones.cuestion-religiosa-1931.meta.titulo -->
«España ha dejado de ser católica» · 13 October 1931

<!-- sesiones.cuestion-religiosa-1931.meta.descripcion -->
The session on the religious article of the Constitution in the Diario: Azaña's speech, the roll-call vote and the night on which it was debated.

<!-- sesiones.cuestion-religiosa-1931.antetitulo -->
13 October 1931 · Session no. {{sesion.1931-10-13-55.num|id}} · Constituent · DSCCRE no. {{sesion.1931-10-13-55.diario_num|id}}, pp. {{sesion.1931-10-13-55.paginas}} (project metadata)

<!-- sesiones.cuestion-religiosa-1931.titulo -->
«España ha dejado de ser católica»

<!-- sesiones.cuestion-religiosa-1931.entrada -->
‘Spain has ceased to be Catholic’ (our translation). What happened in this session, and how do I read it in full?

## What happened

<!-- sesiones.cuestion-religiosa-1931.que_paso.texto -->
The Constituent Cortes debate article 24 of the draft Constitution. The Secretary reads out its new wording, which begins:
...
In the end, the article is approved in a roll-call vote. Alcalá-Zamora and Maura, both members of the provisional Government, are on the list of noes.

<!-- sesiones.cuestion-religiosa-1931.que_paso.4 -->
The next day, the Diario already heads Azaña's rows «Presidente del Gobierno» (Prime Minister).
...
It is a long session, with many short rows of the Chair between the speeches. The tallest bar is Azaña's.

## The vote

<!-- sesiones.cuestion-religiosa-1931.votacion.texto -->
A single bar: article 24, approved by {{voto.178-59.si}} votes to {{voto.178-59.no}}.
...
The ready-made debate «Cuestión religiosa (art. 26)» (the religious question) gathers {{bib.religiosa.entradas}} interventions from {{bib.religiosa.sesiones|letra}} sessions. Its name uses a different article number from the Diario of that day, which refers to article 24.

## What is not there

<!-- sesiones.cuestion-religiosa-1931.no_esta.texto -->
This session does not tell why Azaña goes on to head the Government. The Diario only records the change of heading the next day.
