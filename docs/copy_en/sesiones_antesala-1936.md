# Copy EN · Gateway `antesala-1936` · 16 June and 1 July 1936 · The prelude

> [nota de diseño] Traducción de `docs/copy_es/sesiones_antesala-1936.md` según el glosario. Las citas (claves
> `.cita.`) y la consulta quedan en español; la traducción de las citas, en `_trad_pendientes.txt`.

<!-- sesiones.antesala-1936.meta.titulo -->
The prelude · 16 June and 1 July 1936

<!-- sesiones.antesala-1936.meta.descripcion -->
Two sessions of 1936 on public order: what Calvo Sotelo, Casares Quiroga and Galarza said, and what the Diario does not record.

<!-- sesiones.antesala-1936.antetitulo -->
16 June and 1 July 1936 · Sessions no. {{sesion.1936-06-16-45.num|id}} and {{sesion.1936-07-01-54.num|id}} · Cortes of 1936 · DSC no. {{sesion.1936-06-16-45.diario_num|id}}, pp. {{sesion.1936-06-16-45.paginas}}, and no. {{sesion.1936-07-01-54.diario_num|id}}, pp. {{sesion.1936-07-01-54.paginas}} (project metadata)
...
Two sessions on public order, a few weeks before the war. Diego Martínez Barrio is in the Chair for both.

<!-- sesiones.antesala-1936.que_paso.2 -->
On 16 June, Calvo Sotelo clashes with the President of the Council of Ministers, Casares Quiroga. That day, the Diario twice notes words left out of the record on the Chair's orders.
...
The ready-made debate «Orden público en la primavera de 1936» (public order in the spring of 1936) gathers {{bib.orden_publico.entradas}} interventions from {{bib.orden_publico.sesiones|letra}} sessions, from April to July 1936.
