# Copy EN · Gateway `mexico-1945` · 17 August and 7 to 9 November 1945 · Mexico

> [nota de diseño] Traducción de `docs/copy_es/sesiones_mexico-1945.md` según el glosario. Las citas (claves
> `.cita.`), la consulta y los filtros del explorador quedan en español; la traducción de las citas, en
> `_trad_pendientes.txt`.

<!-- sesiones.mexico-1945.meta.titulo -->
Mexico · 1945

<!-- sesiones.mexico-1945.meta.descripcion -->
The Cortes meeting in Mexico City in 1945: Martínez Barrio's oath as acting President of the Republic and Giral's Government.

<!-- sesiones.mexico-1945.antetitulo -->
17 August and 7 to 9 November 1945 · Sessions no. {{sesion.1945-08-17-71.num|id}} to {{sesion.1945-11-09-74.num|id}} · Mexico · Official summary of the sessions held in Mexico, pages unverified (project metadata)

<!-- sesiones.mexico-1945.titulo -->
Mexico

<!-- sesiones.mexico-1945.entrada -->
What happened in these sessions, and how do I read them in full?

## What happened

<!-- sesiones.mexico-1945.que_paso.texto -->
In 1945 the Cortes meet in Mexico City. This gateway opens {{puerta.mexico-1945.sesiones|letra}} of their {{fuente.serie.extracto_mexico|letra}} sessions.

<!-- sesiones.mexico-1945.que_paso.2 -->
On 17 August, Diego Martínez Barrio, President of the Cortes, takes the oath as acting President of the Republic. The Vice-President Luis Fernández Clérigo chairs the session.

<!-- sesiones.mexico-1945.que_paso.3 -->
On 7 November, José Giral presents his Government to the Chamber. The next day, the Chamber approves his statement in an ordinary vote. On 9 November, among other business, it debates the Statute of Galicia.

<!-- sesiones.mexico-1945.que_paso.4 -->
The first of the Mexico sessions, that of 10 January 1945, is on the stage page.
...
The ready-made debate «Las Cortes en el exilio» (the Cortes in exile) gathers {{bib.exilio.entradas}} interventions from the {{bib.exilio.sesiones|letra}} Mexico sessions.

## What is not there

<!-- sesiones.mexico-1945.no_esta.texto -->
Between Figueres and Mexico, the Standing Committee (Diputación Permanente) also met. Its meetings are not in the corpus; of those held in Mexico, the cover of the volume says:
