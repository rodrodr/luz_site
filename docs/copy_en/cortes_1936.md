# Copy EN · Stage III · The Cortes of 1936, until the war (`/[lang]/cortes/1936/`)

> Traducción del copy español congelado (`docs/copy_es/cortes_1936.md`), según `docs/03a_GLOSARIO_es-en.md`. Las
...
<!-- cortes.1936.meta.titulo --> The Cortes of 1936, until the war
<!-- cortes.1936.meta.descripcion --> From March to July 1936: the opening, the credentials, the removal of Alcalá-Zamora from office and what the Diario was ordered to strike out, row by row.
<!-- cortes.1936.miga --> The Cortes / III
<!-- cortes.1936.titulo --> The Cortes of 1936, until the war

<!-- cortes.1936.antetitulo -->
16-III → 10-VII-1936 · {{etapa.III.sesiones}} sessions · {{etapa.III.serie}}

<!-- cortes.1936.entrada -->
What was said in the Chamber of 1936 before the war?

<!-- cortes.1936.tension -->
It is the most quoted stage, and the one most often told with phrases that are not in the Diario. Here is what the Diario does record, including the orders to strike words out.

## Today you can

<!-- cortes.1936.hoy.buscar -->
**Search within this stage.** In «Facetas» (facets), tick the «Legislatura» (legislature) «1936-1939» and set «Desde» (from) 16/03/1936 and «Hasta» (to) 10/07/1936: the legislature alone would also bring in the war and Mexico.
...
**Add a ready-made debate.** In «Mis bibliotecas» (my libraries), select «Añadir bibliotecas del proyecto…» (add the project's libraries) and choose «Orden público en la primavera de 1936» (public order in the spring of 1936).

<!-- cortes.1936.hoy.tendencia -->
**Follow a word over time.** Search for «orden público» (the query from the first task), press `t` to open «Tendencia» (trend) and choose the period «1936–45». Read only up to July 1936: after that come the extracts from the war.
...
[A] Manuel Álvarez Tardío and Roberto Villa García, *1936. Fraude y violencia en las elecciones del Frente Popular*. Barcelona: Espasa, 2017. · [A] Eduardo González Calleja and Francisco Sánchez Pérez, «Revisando el revisionismo. A propósito del libro *1936. Fraude y violencia en las elecciones del Frente Popular*», *Historia Contemporánea*, 58, 2018, pp. 851–881.

### The removal from office (3 and 7 April)
...
<!-- cortes.1936.contexto.4.titulo --> Presidencies and Governments (April and May)
...
<!-- cortes.1936.contexto.6.titulo --> The prelude and the last session (June and July)
...
The Chamber of 1936 met in each of the {{etapa.III.meses_con_sesion|letra}} months it had before the war, from March to July, without an empty month.

<!-- cortes.1936.calendario.presidente -->
Under the calendar run two bands from the project metadata. Diego Martínez Barrio is President of the Cortes for {{etapa.III.pres.martinez_barrio}} sessions.
...
[A] Manuel Álvarez Tardío and Roberto Villa García, *1936. Fraude y violencia en las elecciones del Frente Popular*. Barcelona: Espasa, 2017.

<!-- cortes.1936.leer.gonzalez_sanchez -->
[A] Eduardo González Calleja and Francisco Sánchez Pérez, «Revisando el revisionismo. A propósito del libro *1936. Fraude y violencia en las elecciones del Frente Popular*», *Historia Contemporánea*, 58, 2018, pp. 851–881.
