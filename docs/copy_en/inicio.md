...
It does not have these columns; they would have to be built.

<!-- inicio.falta.tema -->
**Topic.** There is no topic column: each search is a hypothesis of yours.

<!-- inicio.falta.tono -->
**Tone.** The bracketed notes are in the text; tone is not measured.

<!-- inicio.falta.posicion -->
**Position.** Ideology classifies the deputy, not what they said.

<!-- inicio.falta.voto -->
**Vote.** The roll-call lists are in the text, not in a column.

<!-- inicio.falta.afinidades -->
One derived dataset already exists: Afinidades Elegidas, who co-signed with whom.
