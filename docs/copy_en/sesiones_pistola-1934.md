# Copy EN · Gateway `pistola-1934` · 4 July 1934 · Prieto's pistol

> [nota de diseño] Traducción de `docs/copy_es/sesiones_pistola-1934.md` según el glosario. Las citas (claves
...
Prieto's pistol · 4 July 1934

<!-- sesiones.pistola-1934.meta.descripcion -->
A session of the Cortes elected in 1933 that ends in blows: what the shorthand writer notes, Prieto's version and Oriol de la Puerta's.

<!-- sesiones.pistola-1934.antetitulo -->
4 July 1934 · Session no. {{sesion.1934-07-04-112.num|id}} · 1933-1935 · DSC no. {{sesion.1934-07-04-112.diario_num|id}}, pp. {{sesion.1934-07-04-112.paginas}} (project metadata)
...
It is night and the Chamber is debating Catalonia. Santiago Alba is in the Chair.

<!-- sesiones.pistola-1934.que_paso.2 -->
While Gil Robles is speaking, two deputies come to blows: Tirado, a Socialist, and Oriol de la Puerta, an Agrarian. The Chair suspends the session for a few minutes.

<!-- sesiones.pistola-1934.que_paso.3 -->
On their return, Prieto gives his version and admits that he drew his pistol. Oriol de la Puerta answers him.

<!-- sesiones.pistola-1934.que_paso.4 -->
It is the last session before the summer: the next one is on {{puerta.pistola-1934.siguiente|fecha_larga}}.
...
Indalecio Prieto, in the same row
...
After the suspension, the figure shows the consecutive turns of the Chair, Prieto, Oriol de la Puerta and Tirado.
...
The Diario does not say who drew a pistol first. It gives two versions: Prieto's, who drew his after seeing another, and Oriol de la Puerta's.
