# Copy EN · Stage IV · The Cortes at war, 1936–1939 (`/[lang]/cortes/guerra/`)

> Traducción del copy español congelado (`docs/copy_es/cortes_guerra.md`), según `docs/03a_GLOSARIO_es-en.md`. Las
...
<!-- cortes.guerra.meta.titulo --> The Cortes at war, 1936–1939
<!-- cortes.guerra.meta.descripcion --> The sessions of the Cortes during the Civil War, from Madrid to Figueres: where they met, what they voted on and what the official extract itself says about them.
<!-- cortes.guerra.miga --> The Cortes / IV
<!-- cortes.guerra.titulo --> The Cortes at war

<!-- cortes.guerra.antetitulo -->
1-X-1936 → 1-II-1939 · {{etapa.IV.sesiones}} sessions · {{etapa.IV.serie}}

<!-- cortes.guerra.entrada -->
What remains of a Cortes that kept meeting during the war?

<!-- cortes.guerra.tension -->
Official extracts remain, not the full Diario. Here are all its sessions, one by one, and what is missing.

## Today you can

<!-- cortes.guerra.hoy.buscar -->
**Search within this stage.** In «Facetas» (facets), tick the «Legislatura» (legislature) «1936-1939» and set «Desde» (from) 01/10/1936 and «Hasta» (to) 01/02/1939.
...
**Add a ready-made debate.** In «Mis bibliotecas» (my libraries), select «Añadir bibliotecas del proyecto…» (add the project's libraries) and choose «Las Cortes en guerra» (the Cortes at war).
...
### Where they met: the text says so
...
<!-- cortes.guerra.sesiones.titulo --> The sessions, one by one

<!-- cortes.guerra.sesiones.1936-10-01-61 --> 1-X-1936 · Madrid. Largo Caballero presents his Government; the Statute of the Basque Country is approved.
<!-- cortes.guerra.sesiones.1936-12-01-62 --> 1-XII-1936 · Valencia. Martínez Barrio thanks the city for its welcome; Largo Caballero appears again before the Chamber.
<!-- cortes.guerra.sesiones.1937-02-01-63 --> 1-II-1937 · A third Vice-President and a fourth Secretary are elected; Largo Caballero speaks.
<!-- cortes.guerra.sesiones.1937-10-01-64 --> 1-X-1937 · Valencia, in the Lonja. Negrín presents his Government; a reform of the Standing Orders is taken into consideration.
<!-- cortes.guerra.sesiones.1937-10-02-65 --> 2-X-1937 · Pestaña and Albornoz clash with the Chair; Ibárruri, Corominas and Lasarte speak.
<!-- cortes.guerra.sesiones.1938-02-01-66 --> 1-II-1938 · The Chamber remembers Pestaña and Sentís, who have died; Negrín appears before it.
<!-- cortes.guerra.sesiones.1938-09-30-67 --> 30-IX-1938 · Sant Cugat. Ibárruri is elected fourth Vice-President; Negrín rejects confidence «con reservas».
<!-- cortes.guerra.sesiones.1938-10-01-68 --> 1-X-1938 · Budget and ratification of decrees; the sessions are suspended «hasta nuevo aviso».
<!-- cortes.guerra.sesiones.1939-02-01-69 --> 1-II-1939 · Figueres, in the castle. Negrín; final roll-call vote.

## When it met

<!-- cortes.guerra.calendario.entrada -->
Of the stage's {{etapa.IV.meses}} months, {{etapa.IV.meses_con_sesion}} have a session. The rest are outlined; their cause does not come from the corpus.

<!-- cortes.guerra.calendario.presidente -->
Under the calendar run two bands from the project metadata. Diego Martínez Barrio is President of the Cortes for all {{etapa.IV.pres.martinez_barrio|letra}}.

<!-- cortes.guerra.calendario.gobiernos -->
The Governments band runs from Largo Caballero to Negrín.
...
These are official extracts, not the full Diario: part of each session is told in the editor's own sentences.
...
[A] Matilde de la Torre, *Las Cortes republicanas durante la Guerra Civil. Madrid 1936, Valencia 1937 y Barcelona 1938*, edited by Francisca Vilches-de Frutos. Madrid: Fondo de Cultura Económica de España, 2015.
