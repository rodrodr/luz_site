# Copy EN · Stage V · The Cortes in Mexico, 1945 (`/[lang]/cortes/mexico/`)

> Traducción del copy español congelado (`docs/copy_es/cortes_mexico.md`), según `docs/03a_GLOSARIO_es-en.md`. Las
...
<!-- cortes.mexico.meta.titulo --> The Cortes in Mexico, 1945
<!-- cortes.mexico.meta.descripcion --> The Cortes that met in Mexico in 1945: an oath, a Government and the list of those who were gone, in the words of the official extract.
<!-- cortes.mexico.miga --> The Cortes / V
<!-- cortes.mexico.titulo --> The Cortes in Mexico

<!-- cortes.mexico.antetitulo -->
10-I → 9-XI-1945 · {{etapa.V.sesiones}} sessions · {{etapa.V.serie}}

<!-- cortes.mexico.entrada -->
What did the Cortes do when they met again, in Mexico, in 1945?

<!-- cortes.mexico.tension -->
An oath, a Government and the list of those who were gone, told in the words of the extract.

## Today you can

<!-- cortes.mexico.hoy.buscar -->
**Search within this stage.** In «Facetas» (facets), tick the «Legislatura» (legislature) «1936-1939» and set «Desde» (from) 10/01/1945 and «Hasta» (to) 09/11/1945: the explorer files these sessions under that legislature.
...
**Add a ready-made debate.** In «Mis bibliotecas» (my libraries), select «Añadir bibliotecas del proyecto…» (add the project's libraries) and choose «Las Cortes en el exilio» (the Cortes in exile).
...
<!-- cortes.mexico.sesiones.titulo --> The sessions, one by one

<!-- cortes.mexico.sesiones.1945-01-10-70 --> 10-I-1945 · Martínez Barrio in the Chair. List of resolutions of the Standing Committee and list of deputies who have died.
<!-- cortes.mexico.sesiones.1945-08-17-71 --> 17-VIII-1945 · Fernández Clérigo in the Chair. Martínez Barrio's oath as interim President of the Republic.
<!-- cortes.mexico.sesiones.1945-11-07-72 --> 7-XI-1945 · Jiménez de Asúa in the Chair. Giral presents his Government; confidence, by acclamation.
<!-- cortes.mexico.sesiones.1945-11-08-73 --> 8-XI-1945 · The Government's statement on the presidential election is approved; Prieto, Fernández Clérigo and Galarza explain their votes.
<!-- cortes.mexico.sesiones.1945-11-09-74 --> 9-XI-1945 · Bureau, Standing Committee and committee for the Statute of Galicia; the sessions close.

## When it met

<!-- cortes.mexico.calendario.entrada -->
After the gap from 1939 to 1945, {{etapa.V.meses_con_sesion|letra}} months of 1945 have a session: January, August and November.

<!-- cortes.mexico.calendario.presidente -->
Under the calendar run two bands from the project metadata. Martínez Barrio chairs the first session; Fernández Clérigo, the session of the oath; Jiménez de Asúa, those of November.

<!-- cortes.mexico.calendario.gobiernos -->
The Governments band passes from Negrín's to Giral's. The corpus says only that Giral received the commission from the interim President; the date of the change comes from the project and is still to be verified.
...
[A] José María del Valle, *Las instituciones de la República española en exilio*. Paris: Ruedo Ibérico, 1976.
