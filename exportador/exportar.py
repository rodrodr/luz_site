...
Pasos
  ...
  3  Módulos, en orden: base, cortes, sesiones, diario, metodo, datos, explorador, afinidades, laboratorio, erratas, aplausos. Cada uno devuelve
...
MODULOS = ["base", "cortes", "sesiones", "diario", "metodo", "datos", "explorador", "afinidades", "laboratorio", "erratas", "aplausos"]
